...
class AStarApp:
    def __init__(self, root):
        self.root = root
        self.root.title("A* Pathfinding Algorithm Visualization")
        ...
        self.start_button = tk.Button(root, text="Run A* Algorithm", command=self.run_a_star)
    ...
    def run_a_star(self):
        # Initialize the closed list and cell details
    ...
    def select_obstacle(self, event):
        ...
        if self.is_valid(row, col):
            # Toggle obstacle state (1 for unblocked, 0 for blocked)
